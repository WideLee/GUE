...
import org.xstuido.gue.view.cards.MyCard;
import org.xstuido.gue.view.cards.MyPlayCard;
...
public class HelloActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mCardView.addCardToLastStack(new MyPlayCard("Google Play",
				"This card mimics the new Google play cards look", "#33b6ea", "#33b6ea", true,
				false));
