package org.xstuido.gue.adapter;
...
public class SignHistoryAdapter extends BaseAdapter {
	...
	ViewHolder vh = null;
	if (convertView == null) {
	    convertView = LayoutInflater.from(mContext).inflate(R.layout.lvi_signin_history,
		    parent, false);
	    vh = new ViewHolder();
	    vh.mGetupTimeTextView = (TextView) convertView.findViewById(R.id.tv_get_up_time);
	    vh.mSignTimeTextView = (TextView) convertView.findViewById(R.id.tv_sign_time);
	    vh.mMindTextView = (TextView) convertView.findViewById(R.id.tv_mind);
	...
	String mon = month < 10 ? "0" + Integer.toString(month) : Integer.toString(month);
	String day = date < 10 ? "0" + Integer.toString(date) : Integer.toString(date);
	return mon + "." + day;
    }
	...
	public TextView mSignTimeTextView;
