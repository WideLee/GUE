...
public class MyPlayCard extends RecyclableCard {
	...
	public MyPlayCard(String titlePlay, String description, String color, String titleColor,
	...
	protected void applyTo(View convertView) {
		...
		((ImageView) convertView.findViewById(R.id.stripe)).setBackgroundColor(Color
				.parseColor(color));
