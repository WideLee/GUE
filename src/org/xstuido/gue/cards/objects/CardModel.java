...
public class CardModel implements Serializable {
	 ...
	 * @param title
	 */
	public CardModel(String description, String title, Class<? extends AbstractCard> cardClass) {
	 ...
	 * @param isClickable
	 */
	public CardModel(String titlePlay, String description, String color, String titleColor,
			Boolean hasOverflow, Boolean isClickable, Class<? extends AbstractCard> cardClass) {
	 ...
	 */
	public CardModel(String titlePlay, String description, String color, String titleColor,
			Boolean hasOverflow, Boolean isClickable, Object data,
			Class<? extends AbstractCard> cardClass) {
		this.titlePlay = titlePlay;
		this.description = description;
		this.color = color;
	 ...
	 * @param data
	 */
	public CardModel(int image, String description, String color, String titleColor, String desc,
			String title, String titlePlay, Boolean hasOverflow, Boolean isClickable, int imageRes,
