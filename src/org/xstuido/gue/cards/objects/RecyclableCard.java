...
public abstract class RecyclableCard extends Card {
	...
	public RecyclableCard(String titlePlay, String description, int imageRes, String titleColor,
	...
	public RecyclableCard(String titlePlay, String description, String color, String titleColor,
			Boolean hasOverflow, Boolean isClickable) {
