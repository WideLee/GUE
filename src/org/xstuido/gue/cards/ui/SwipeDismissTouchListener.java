...
package org.xstuido.gue.cards.ui;
...
public class SwipeDismissTouchListener implements View.OnTouchListener {
	...
	case MotionEvent.ACTION_UP: {
		...
		// cancel
		animate(mView).translationX(0).alpha(1).setDuration(mAnimationTime)
			.setListener(null);
	...
	case MotionEvent.ACTION_MOVE: {
		...
		setAlpha(mView,
			Math.max(0f, Math.min(1f, 1f - 0.5f * Math.abs(deltaX) / mViewWidth)));
		return true;
	    }
	    break;
	}
