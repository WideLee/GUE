...
public class TodayToDoFragment extends Fragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case Constant.MESSAGE_GET_WEATHER_FAIL:
                    Tool.showToast(getActivity(), msg.obj.toString());
                    break;
                case Constant.MESSAGE_SWIPE_TODO_CARD:
                    Tool.showToast(getActivity(), "成功完成任务");
                ...
                case Constant.MESSAGE_SWIPE_WEATHER_CARD:
                    Tool.showToast(getActivity(), "暂时隐藏天气卡片");
                ...
                case Constant.MESSAGE_SWIPE_SIGNIN_CARD:
                    ...
                    mCardView.refresh();
                    break;
                case Constant.MESSAGE_AD_SHOW_DONE:
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mLoadingDialog.setMessage(getString(R.string.more_app));
        ...
        mMoreImageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // R.anim.out_to_left);
                mLoadingDialog.show();
                AdView adView = AdView.createPopup(getActivity(), Constant.APP_KEY);
                adView.setAdListener(new O2OAdListenerImpl());
                adView.request();
            }
        });
        mMoreImageView.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Tool.showBannerToast(getActivity(), getString(R.string.help_banner_more_app));
                return true;
            }
        });
        ...
        mSettingImageView.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Tool.showBannerToast(getActivity(), getString(R.string.help_banner_weather));
                return true;
            }
        });
     ...
     *
     * @return 日程事件的列表
     * @throws ParseException 日期格式错误的时候抛出异常
     */
    ...
    public class O2OAdListenerImpl implements O2OAdListener {
        ...
        @Override
        public void onClick() {
            // Toast.makeText(MainActivity.this, "o2o广告点击", 1000).show();
        }

        @Override
        public void onClose() {
            // Toast.makeText(MainActivity.this, "o2o广告关闭", 1000).show();
        }

        @Override
        public void onAdFailed() {
            Tool.showToast(getActivity(), "请检查网络连接");
            mHandler.sendEmptyMessage(Constant.MESSAGE_AD_SHOW_DONE);
        }


        @Override
        public void onAdSuccess() {
            Tool.showToast(getActivity(), "谢谢您的支持^_^)y");
            mHandler.sendEmptyMessage(Constant.MESSAGE_AD_SHOW_DONE);
        }
    }
}
