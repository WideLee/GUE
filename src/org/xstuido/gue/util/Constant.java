...
public class Constant {
	...
	public static final int MESSAGE_SWIPE_SIGNIN_CARD = 9;

	public static final int MESSAGE_SCREEN_SHOT_DONE = 4;
	public static final int MESSAGE_SCREEN_SHOT_FAIL = 5;

	public static final int MESSAGE_LOADING_DONE = 10;
	public static final int MESSAGE_LOADING_FAIL = 11;

	public static final int REQUEST_CODE_ADD_EVENT = 6;
	public static final int REQUEST_CODE_UPDATE_EVENT = 7;
	public static final int REQUEST_CODE_SIGNIN = 8;
