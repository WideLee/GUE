...
public class Tool {
    ...
    public static void showToast(Activity context, String text) {
        ...
        TextView tv = (TextView) layout.findViewById(R.id.tv_popup_toast);
        tv.setText(text);
        Toast toast = new Toast(context);
        toast.setGravity(Gravity.BOTTOM, 0, dip2px(96));
        toast.setDuration(Toast.LENGTH_SHORT);
        toast.setView(layout);
        toast.show();
    }

    public static void showBannerToast(Activity context, String text) {
        LayoutInflater inflater = context.getLayoutInflater();
        View layout = inflater.inflate(R.layout.toast_layout, null);
        TextView tv = (TextView) layout.findViewById(R.id.tv_popup_toast);
        tv.setText(text);
     ...
     * @param toast 需要显示通知的内容
     */
    public static void showLongToast(Activity context, String text) {
        /*if (!TextUtils.isEmpty(toast)) {
